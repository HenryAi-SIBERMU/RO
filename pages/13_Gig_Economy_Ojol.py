...
with st.expander("🔗 Kode Embed WordPress — Gambar 25 (HTML)"):
    st.code("""<!-- Gambar 25: Mekanisme Pembagian Komisi Ojek Online -->
<iframe src="https://henryai-sibermu.github.io/RO/embed/13_Gig_Economy_Ojol_gambar25_plotly.html"
  ...
  style="border-radius:32px; background:transparent;" loading="lazy"></iframe>""", language="html")
...
chart_footer("Wawancara kualitatif dengan Pengemudi Ojek Online, 2026")
with st.expander("🔗 Kode Embed WordPress — Gambar 26 (HTML)"):
