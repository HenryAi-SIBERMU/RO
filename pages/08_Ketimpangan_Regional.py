...
chart_header(
    "Ketersediaan Jaminan Kecelakaan di Tempat Kerja",
    "Gambar 21b — Hal. 35",
)
...
with st.expander("🔗 Kode Embed WordPress — Gambar 21b (Plotly)"):
    st.code(
        """<!-- Gambar 21b: Ketersediaan Jaminan Kecelakaan di Tempat Kerja — Plotly -->
<iframe
  src="https://henryai-sibermu.github.io/RO/embed/08_Ketimpangan_Regional_gambar21b_plotly.html"
  width="100%" height="620" frameborder="0"
  style="border-radius:32px; background:#f5f3ff;"
  loading="lazy">
</iframe>""",
...
chart_header(
    "Ketersediaan Jaminan Kematian di Tempat Kerja",
    "Gambar 21c — Hal. 35",
)
...
with st.expander("🔗 Kode Embed WordPress — Gambar 21c (Plotly)"):
    st.code(
        """<!-- Gambar 21c: Ketersediaan Jaminan Kematian di Tempat Kerja — Plotly -->
<iframe
  src="https://henryai-sibermu.github.io/RO/embed/08_Ketimpangan_Regional_gambar21c_plotly.html"
  width="100%" height="620" frameborder="0"
  style="border-radius:32px; background:#f5f3ff;"
  loading="lazy">
</iframe>""",
...
chart_header(
    "Ketersediaan Jaminan Hari Tua di Tempat Kerja",
    "Gambar 21d — Hal. 36",
)
...
chart_header(
    "Ketersediaan Jaminan Kehilangan Pekerjaan",
    "Gambar 21f — Hal. 36",
)
...
with st.expander("🔗 Kode Embed WordPress — Gambar 21f (Plotly)"):
    st.code(
        """<!-- Gambar 21f: Ketersediaan Jaminan Kehilangan Pekerjaan — Plotly -->
<iframe
...
chart_header(
    "UMR yang Tidak Cukup untuk Menghidupi Keluarga",
    "Gambar 24 — Hal. 39",
)
...
with st.expander("🔗 Kode Embed WordPress — Gambar 24 (Plotly)"):
    st.code(
        """<!-- Gambar 24: UMR yang Tidak Cukup untuk Menghidupi Keluarga — Plotly -->
<iframe
  src="https://henryai-sibermu.github.io/RO/embed/08_Ketimpangan_Regional_gambar24_plotly.html"
